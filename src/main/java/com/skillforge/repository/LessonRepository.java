...
public interface LessonRepository extends JpaRepository<Lesson, String> {
  ...
  @Query(
      "SELECT l FROM Lesson l WHERE l.module.course.id = :courseId ORDER BY l.module.orderIndex, l.orderIndex")
  List<Lesson> findAllLessonsByCourse(@Param("courseId") String courseId);

  @Modifying
  @Query(
      "UPDATE Lesson l SET l.orderIndex = l.orderIndex + 1 WHERE l.module.id = :moduleId AND l.orderIndex >= :fromIndex")
