...
public abstract class CourseMapper {
    ...
    @Mapping(target = "difficultyLevel", source = "difficultyLevel", qualifiedByName = "stringToDifficultyLevel")
    ...
    @Mapping(target = "ratingStars", expression = "java(generateRatingStars(course.getAverageRating()))")
    @Mapping(target = "difficultyLevel", source = "difficultyLevel", qualifiedByName = "difficultyLevelToString")
    ...
    protected String generateRatingStars(Double rating) {
